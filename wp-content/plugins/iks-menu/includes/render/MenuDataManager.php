...
class MenuDataManager
{
     ...
     * @since 1.8.0
     */
    private function is_term_includes_post( $id, $taxonomy )
    {
        global  $wp_query ;
    ...
    private function is_current_item( $link, $id )
    {
        ...
        return $this->page_url === $result_link || $this->permalink === $result_link || Utils::object_has_property( $this->queried_object, 'term_id' ) && $this->queried_object->term_id === $id;
    }
